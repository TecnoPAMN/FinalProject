...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2015 a las 20:00:39
...
--
-- Base de datos: `competition_platform`
--
...
--
-- Estructura de tabla para la tabla `admin_competition`
--

CREATE TABLE IF NOT EXISTS `admin_competition` (
  `admin_competition_id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `admin_delegation`
--

CREATE TABLE IF NOT EXISTS `admin_delegation` (
  `admin_delegation_id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `athlete_competition`
--
...
--
-- Estructura de tabla para la tabla `athlete_discipline`
--

CREATE TABLE IF NOT EXISTS `athlete_discipline` (
  `athlete_id` int(11) NOT NULL,
...
INSERT INTO `country` (`country_id`, `sortname`, `name`) VALUES
(1, 'AF', 'Afghanistan'),
(2, 'AL', 'Albania'),
(3, 'DZ', 'Algeria'),
(4, 'AS', 'American Samoa'),
...
--
-- Estructura de tabla para la tabla `delegation`
--

CREATE TABLE IF NOT EXISTS `delegation` (
  `delegation_id` int(11) NOT NULL,
  `name` varchar(40) NOT NULL,
  `members_qty` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `main_competition`
--

CREATE TABLE IF NOT EXISTS `main_competition` (
  `main_competition_id` int(11) NOT NULL,
  `description` varchar(511) NOT NULL,
  `region_id` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  `style_type` int(11) NOT NULL DEFAULT '0',
...
--
ALTER TABLE `admin`
  ADD PRIMARY KEY (`admin_id`), ADD UNIQUE KEY `email_UNIQUE` (`email`);

--
-- Indices de la tabla `admin_competition`
--
ALTER TABLE `admin_competition`
  ADD PRIMARY KEY (`admin_competition_id`,`main_competition_id`);

--
-- Indices de la tabla `admin_delegation`
--
ALTER TABLE `admin_delegation`
  ADD PRIMARY KEY (`admin_delegation_id`,`delegation_id`);

--
-- Indices de la tabla `athlete`
--
ALTER TABLE `athlete`
  ADD PRIMARY KEY (`athlete_id`), ADD KEY `delegation_id` (`delegation_id`);

--
-- Indices de la tabla `athlete_competition`
--
ALTER TABLE `athlete_competition`
  ADD KEY `athlete_id` (`athlete_id`), ADD KEY `delegation_id` (`competition_id`), ADD KEY `competition_id` (`competition_id`);

--
-- Indices de la tabla `athlete_discipline`
--
ALTER TABLE `athlete_discipline`
  ADD KEY `athlete_id` (`athlete_id`), ADD KEY `discipline_id` (`discipline_id`);

--
-- Indices de la tabla `competition`
--
ALTER TABLE `competition`
  ADD PRIMARY KEY (`competition_id`), ADD KEY `main_competition_id_idx` (`main_competition_id`), ADD KEY `location_id` (`location_id`), ADD KEY `discipline_id` (`discipline_id`);
...
--
-- Indices de la tabla `delegation`
--
...
--
-- Indices de la tabla `main_competition`
--
ALTER TABLE `main_competition`
  ADD PRIMARY KEY (`main_competition_id`);

--
-- Indices de la tabla `post`
--
ALTER TABLE `post`
  ADD PRIMARY KEY (`post_id`), ADD KEY `admin_competition_id_idx` (`admin_competition_id`);
...
ALTER TABLE `subscriber`
  ADD PRIMARY KEY (`subscriber_id`), ADD UNIQUE KEY `mail_UNIQUE` (`email`);
...
--
-- AUTO_INCREMENT de la tabla `athlete`
--
ALTER TABLE `athlete`
...
--
-- AUTO_INCREMENT de la tabla `delegation`
--
ALTER TABLE `delegation`
...
--
ALTER TABLE `region`
  MODIFY `region_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4121;
--
-- Restricciones para tablas volcadas
--

--
-- Filtros para la tabla `admin_competition`
--
ALTER TABLE `admin_competition`
ADD CONSTRAINT `admin_competition_id` FOREIGN KEY (`admin_competition_id`) REFERENCES `admin` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `admin_delegation`
--
ALTER TABLE `admin_delegation`
ADD CONSTRAINT `admin_delegation_id` FOREIGN KEY (`admin_delegation_id`) REFERENCES `admin` (`admin_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `athlete`
--
ALTER TABLE `athlete`
ADD CONSTRAINT `athlete_ibfk_1` FOREIGN KEY (`delegation_id`) REFERENCES `delegation` (`delegation_id`);

--
-- Filtros para la tabla `athlete_competition`
--
ALTER TABLE `athlete_competition`
ADD CONSTRAINT `athlete_competition_ibfk_1` FOREIGN KEY (`athlete_id`) REFERENCES `athlete` (`athlete_id`),
ADD CONSTRAINT `athlete_competition_ibfk_2` FOREIGN KEY (`competition_id`) REFERENCES `competition` (`competition_id`);

--
-- Filtros para la tabla `athlete_discipline`
--
ALTER TABLE `athlete_discipline`
ADD CONSTRAINT `athlete_discipline_ibfk_1` FOREIGN KEY (`athlete_id`) REFERENCES `athlete` (`athlete_id`),
ADD CONSTRAINT `athlete_discipline_ibfk_2` FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`);

--
-- Filtros para la tabla `competition`
--
ALTER TABLE `competition`
ADD CONSTRAINT `competition_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`),
ADD CONSTRAINT `competition_ibfk_2` FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`),
ADD CONSTRAINT `main_competition_id` FOREIGN KEY (`main_competition_id`) REFERENCES `main_competition` (`main_competition_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `post`
--
ALTER TABLE `post`
ADD CONSTRAINT `post_admin_competition` FOREIGN KEY (`admin_competition_id`) REFERENCES `admin_competition` (`admin_competition_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
